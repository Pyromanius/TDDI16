...
private:
    ...
    static void insert_subtree(const Node_Pointer&, Node_Pointer&);
...
template <typename Comparable>
void AVL_Tree_Node<Comparable>::insert_subtree(const Node_Pointer &x, Node_Pointer &t) {
    if (t == nullptr) {
        t = x;
        return;
    }
    ...
    if (x->element < t->element) {
        insert_subtree(x, t->left);
        calculate_height(t->left);

        if (node_height(t->left) - node_height(t->right) == 2)
            if (x->element < t->left->element)
                single_rotate_with_left_child(t);
            else
                double_rotate_with_left_child(t);
        else
        ...
        insert_subtree(x, t->right);
        calculate_height(t->right);

        if (node_height(t->right) - node_height(t->left) == 2)
            if (t->right->element < x->element)
                single_rotate_with_right_child(t);
            else
                double_rotate_with_right_child(t);
        else
        ...
        throw AVL_Tree_error("insättning subtree: finns redan");
    }
}
...
void AVL_Tree_Node<Comparable>::remove(const Comparable &x, Node_Pointer &t) {
    ...
    if (x < t->element) {
        ...
        // if (t->right != nullptr) {
        //     Node_Pointer smallest_parent = t;
        //     Node_Pointer smallest =  t->right;
        ...
        //     delete t;
        //     t = smallest;
        //     insert_subtree(smallest_parent, t);
        // } else {
        //     Node_Pointer temp = t;
        //     t = t->left;
        //     delete temp;
        ...
        Node_Pointer to_remove = t;
        t = nullptr;

        insert_subtree(to_remove->left, to_remove->right);
        t = to_remove->right;
        ...
        //     delete temp;
        // } else {
        //     // temp is smallest node in value on the right
        //     Node_Pointer temp = t->right;
        //     if (temp != nullptr) {
...
void AVL_Tree_Node<Comparable>::print_tree(ostream &os, const Node_Pointer t, int depth) {
    ...
    //     return;
    // }
    // os << "{ " << "value: " << t->element << ", left: ";
    // print_tree(os, t->left);
    // os << ", right: ";
    // print_tree(os, t->right);
    // os << "}";
    if (t != nullptr) {
        print_tree(os, t->right, depth + 1);
